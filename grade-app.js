...
`;
  ...
  function _buildReport(s) {
    ...
    const hdr=`<div class="rpt-header" style="display:flex;align-items:flex-end;gap:16px;margin-bottom:18px;padding-bottom:14px;border-bottom:2px solid #e5e7eb"><div style="flex-shrink:0;text-align:center"><img src="${_htLogo}" style="width:100px;height:auto;display:block;margin:0 auto"><div style="font-size:12px;font-weight:900;color:#2d6a4f;margin-top:4px">해피트리 영어학원</div><div style="font-size:9px;font-weight:600;color:#74c69d;letter-spacing:.8px">HAPPYTREE ENGLISH ACADEMY</div></div><div style="flex:1;display:flex;align-items:center;justify-content:space-between;padding-bottom:4px"><div class="rpt-title" style="font-size:${_st.reportTitleSize||26}px;font-weight:900;color:#111">Achievement Report</div><div style="font-size:10px;color:#9ca3af">${today}</div></div></div>`;
